...
export const commerceModuleDefinitions: readonly FoundationModuleDefinition[] = [
  { id: "commerce-cart", enabled: false, requiredModules: ["catalog"], optionalModules: ["accounts", "inventory", "personalization", "custom-build"], capabilities: ["commerce.cart"] },
  { id: "commerce-checkout", enabled: false, requiredModules: ["commerce-cart"], optionalModules: ["payments", "shipping", "tax", "accounts", "inventory"], capabilities: ["commerce.checkout"] },
