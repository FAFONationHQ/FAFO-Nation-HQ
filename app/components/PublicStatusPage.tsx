    ...
    <>
      ...
      <main className="min-h-screen bg-black text-white">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl">
          ...
          <h1 className="mt-5 max-w-6xl break-words text-2xl font-black uppercase leading-[0.9] tracking-[-0.05em] sm:text-7xl lg:text-9xl">{title}{" "}<span className="block text-[#D4AF37]">{accentTitle}</span></h1>
