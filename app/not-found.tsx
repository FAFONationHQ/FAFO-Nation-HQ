    ...
    <main className="flex min-h-screen items-center justify-center bg-black px-5 py-20 text-white">
      <section className="w-full max-w-3xl border border-white/15 bg-white/[0.02] px-6 py-16 text-center sm:px-12 sm:py-20">
        ...
        <p className="mx-auto mt-8 max-w-xl text-base leading-8 text-white/60">
          The requested page is not currently available.
        </p>
        <Link
          href="/"
          className="mt-10 inline-flex min-h-12 items-center justify-center border border-red-600/70 px-7 py-3 text-xs font-black uppercase tracking-[0.18em] text-[#D4AF37] shadow-[0_0_12px_rgba(220,38,38,0.45)] transition hover:bg-red-700/30 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-red-600"
        >
          Return Home
        </Link>
      </section>
