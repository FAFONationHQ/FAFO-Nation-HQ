...
export default function Home() {
  ...
  const [deploymentRotationEnabled, setDeploymentRotationEnabled] =
    useState(true);
                ...
                <div className="fafo-deployment-ticker flex w-max items-center">
                  ...
                  {VERIFIED_GEAR_DEPLOYMENTS.map(
                    (location) => (
                      <span
                        key={location}
                        className="flex min-h-9 shrink-0 items-center whitespace-nowrap px-5 text-[9px] font-bold uppercase tracking-[0.18em] text-white/65 sm:px-7 sm:text-[10px]"
                      >
                        FAFO Gear
